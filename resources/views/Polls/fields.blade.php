<div class="row">
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::select('lang_id', getLanguage(), isset($poll) ? $poll->lang_id :null, ['class' => 'form-select io-select2','required','id'=>'pollsLanguage','data-control'=>'select2','placeholder' => __('messages.common.select_language')]) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
