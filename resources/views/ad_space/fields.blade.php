    ...
    <div class="row">
        @if ($sectionID != App\Models\AdSpaces::ALL_DETAILS_SIDE)
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <textarea rows="10" name="ad-code[]" class="w-100">{{ !empty($adBanner[0]->code) ? $adBanner[0]->code : '' }}</textarea>
            </div>
            <hr>
        @endif
        @if ($sectionID != App\Models\AdSpaces::HEADER && $sectionID != App\Models\AdSpaces::ALL_DETAILS_SIDE)
            ...
            <div class="col-lg-6 col-md-12 mt-2">
                {{ Form::label('name', __('messages.ad_space.ad_code') . ':', ['class' => 'form-label required fs-6']) }}
                <textarea rows="10" class="w-100" name="ad-code[]">{{ !empty($adBanner[1]->code) ? $adBanner[1]->code : '' }}</textarea>
            </div>
        @endif
    </div>
    @if ($sectionID == App\Models\AdSpaces::ALL_DETAILS_SIDE)
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mt-2">
                {{ Form::label('name', __('messages.ad_space.ad_code') . ':', ['class' => 'form-label required fs-6']) }}
                <textarea rows="10" class="w-100" name="ad-code[]">{{ !empty($adBanner[0]->code) ? $adBanner[0]->code : '' }}</textarea>
            </div>
