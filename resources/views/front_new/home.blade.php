...
{{--                                            <img data-src="{{ $sliderPost->post_image }}" src="{{ asset('front_web/images/bg-process.png') }}" class="w-100 h-100 lazy" alt=""/>--}}
                                        ...
                                        <div class="hero-content position-absolute px-40 mb-sm-4 mb-3 w-100">
                                            ...
                                            <div class="desc d-sm-flex align-items-center justify-content-between">
                                                <p class="fs-14 text-white mb-sm-0 mb-1"><a href="{{route('userDetails',($sliderPost->user->username ?? $sliderPost->user->id))}}"  class="text-white">{{ __('messages.common.by') }}  {{ $sliderPost->user->full_name }}</a></p>
                                                        ...
                                                        <div class="post-content position-absolute px-30 mb-3 pb-1 w-100">
                                                            ...
                                                            <div class="desc d-sm-flex align-items-center justify-content-between">
                                                                <p class="fs-12 text-white mb-sm-0 mb-1">
                                                                    <a href="{{route('userDetails',($categoryPost->user->username ?? $categoryPost->user->id))}}" class="text-white">{{ __('messages.common.by') }}  {{ $categoryPost->user->full_name }}</a>
                                                                </p>
...
{{--                                                            <img data-src="{{$latestPost->post_image}}" alt="" src="{{ asset('front_web/images/bg-process.png') }}" class="w-100 h-100 lazy">--}}
                                                    ...
                                                    <div class="news-post-content">
                                                        ...
                                                        <div class="desc d-flex">
                                                            ...
                                                            <p class="fs-14 text-black mb-0"><a href="{{route('userDetails',($latestPost->user->username ?? $latestPost->user->id))}}" class="text-black">{{ __('messages.common.by') }}  {{ $latestPost->user->full_name }}</a>
                                                            </p>
