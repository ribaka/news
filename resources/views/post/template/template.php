...
<!--                            </div>-->
                       ...
                       <input type="hidden" value="{{:index}}" id="galleryContentIndex">
...
<!--                            </button>-->
                                 <textarea id="galleryContent" name="gallery_content[{{:i}}]" class="tox-target text-gallery-description form-control" rows="25">
...
<!--                                --><?php //echo __('messages.post.add_image') ?>
<!--                            </button>-->
                            <textarea id="" name="sort_list_content[{{:i}}]" class="tox-target text-sort_list-description" height="200px">
